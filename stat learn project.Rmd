...
```{r}
# columns with correlation with more meaningful ones higher than 0.9 in absolute value
rem9 = c(1,9,11,17,20,28,30,39,41,44,45,54,56,58,59,60,61,64,65,74,80,82,83,85,86,90,91,92)
...
cma_ind <- abs(cm_ind) > 0.9

# perCapInc vs whitePerCap (21 vs 22)
# PctBSorMore vs PctOccupMgmtProf (32 vs 38)
# NumKidsBornNeverMar vs NumImmig (50 vs 52)


corrplot(cma_ind,title='Correlation matrix',method='shade',type='lower',tl.pos='l',tl.cex=0.35)
