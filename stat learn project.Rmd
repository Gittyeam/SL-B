...
It shows up that great tradeoff is to train the final model using the first 12 principal components, and in this way we're able to reach a slightly better accuracy than the previous models, still keepeng low the dimension of the used dataset.
```{r}
